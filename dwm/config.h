...
static const char *fonts[]          = { "Terminus:size=12", "RobotoMono:size=10"};
...
static const char *dmenucmd[] = { "dmenu_run", "-l", "28", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
